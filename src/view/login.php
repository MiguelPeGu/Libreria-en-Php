...
// Importante: Limpiar el mensaje de sesión después de mostrarlo una vez
...
<main> 
    <div class="form-login-container">
        <form action="../Controllers/login-controller.php" method="POST" class="form-login">
            <br><br>
            <i class="fa-solid fa-user-lock" style="font-size: 30px; color: #4e342e; margin-bottom: 15px;"></i>
    ...
    <i class="fa-solid fa-right-to-bracket"></i> Entrar
            ...
            <p class="registro-texto-small">
                ¿Necesitas registrarte?
            </p>

            <a href="register.php" class="btn-register-brown">
