...
public static function crearIdFactura(int $idUsuario) : string
{
    ...
    $fecha = new DateTime();
    $cadena = $fecha->format("Y-m-d H:i:s"); // Ejemplo: 2025-02-19 14:30:55

    // 2. Quitar guiones, espacios y dos puntos
    $cadenaSinSimbolos = str_replace(["-", ":", " "], "", $cadena);
    // Resultado: 20250219143055

    // 3. Invertir la cadena
    $invertido = strrev($cadenaSinSimbolos);
    // Resultado: 55034191250202

    // 4. Combinar con el idUsuario al principio
