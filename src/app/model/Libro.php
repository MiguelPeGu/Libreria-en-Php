...
class Libro
{
    ...
    public function __construct(?int $id, string $isbn, string $img, string $titulo, string $autor, float $precio, float $iva, int $stock, int $stock_lim, string $descripcion)
    {
        $this->id = $id;
        $this->isbn = $isbn;
        $this->img = $img;
